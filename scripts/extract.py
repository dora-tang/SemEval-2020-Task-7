...
col_base = ["model", "transformer", "finetune", "train_extra", "feature", "schedule", "lr", "epochs", "seed"]
if args.task == 'task1':
...
if args.task == 'task2':
    cols = col_base + ["val_accuracy", "val_reward", "val_rmse",
                       "test_accuracy", "test_reward", "test_rmse", 'path']
